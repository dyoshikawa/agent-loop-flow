...
This is agent-loop-flow, a CLI tool for orchestrating AI coding agent workflows. Define skill chains with step transitions and loops via JSONC configuration files.
